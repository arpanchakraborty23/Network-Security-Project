...
from networksecurity.entity.config_entity import DataIngestionConfig,TraningPiplineConfig,DataValidationConfig,DataTransformationConfig
...
if __name__=='__main__':
    try:
        ...
        data_validation=DataValidation(training_pipeline_config=data_validation_config,
